...
```t
# Web URLs
http://ingress-groups-demo601.devopswithsubham.com/app1/index.html
http://ingress-groups-demo601.devopswithsubham.com/app2/index.html
http://ingress-groups-demo601.devopswithsubham.com
```
...
- The below records should be deleted automatically
  - ingress-groups-demo601.devopswithsubham.com
```

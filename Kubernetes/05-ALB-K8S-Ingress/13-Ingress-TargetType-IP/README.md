...
- You should see **Record Sets** added for 
  - target-type-ip-501.devopswithsubham.com 
...
```t
# nslookup commands
nslookup target-type-ip-501.devopswithsubham.com 
```
### Access Application using DNS domain
```t
# Access App1
http://target-type-ip-501.devopswithsubham.com /app1/index.html

# Access App2
http://target-type-ip-501.devopswithsubham.com /app2/index.html

# Access Default App (App3)
http://target-type-ip-501.devopswithsubham.com 
```

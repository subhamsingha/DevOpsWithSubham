...
- **Docker Image Location:** https://hub.docker.com/repository/docker/ssingha/kubenginx
```
# Create Deployment
kubectl create deployment <Deplyment-Name> --image=<Container-Image>
kubectl create deployment my-first-deployment --image=ssingha/kubenginx:1.0.0 
